...
WORKTREE_ROOT = ROOT.parent / "parameter-golf-worktrees" / "2026-03-25-round1"
LOG_DIR = ROOT / "logs" / "round1_seq_20260325"
...
EXPERIMENTS = [
    Experiment("exp03", "parameter-golf/2026-03-25-r1-exp03", "SwiGLU MLP banks at fixed parameter budget"),
    Experiment("exp06", "parameter-golf/2026-03-25-r1-exp06", "Grouped attention value mixer"),
    Experiment("exp08", "parameter-golf/2026-03-25-r1-exp08", "Decoder summary memory residual"),
    Experiment("exp01", "parameter-golf/2026-03-25-r1-exp01", "Per-token residual and skip routing"),
    Experiment("exp04", "parameter-golf/2026-03-25-r1-exp04", "Banked causal FIR token mixer"),
    Experiment("exp05", "parameter-golf/2026-03-25-r1-exp05", "Dual n-gram hash embedding"),
    Experiment("exp07", "parameter-golf/2026-03-25-r1-exp07", "Gated rotary frequency controls"),
    Experiment("exp02", "parameter-golf/2026-03-25-r1-exp02", "Stage-shared banks with low-rank deltas"),
    Experiment("exp09", "parameter-golf/2026-03-25-r1-exp09", "Low-rank adapters for legal TTT"),
    Experiment("exp10", "parameter-golf/2026-03-25-r1-exp10", "Shared banked depth cores across layers"),
]
...
def write_summary(baseline_commit: str, baseline_bpb: float, completed: list[tuple[Experiment, str, float | None, float, str]]) -> None:
